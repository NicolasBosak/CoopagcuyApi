...
namespace CoopagcuyApi.Infrastructure.Data.Migrations
{
    ...
    [Migration("20260703041910_AgregaRegistroIndividualCuyesYRetornos")]
    partial class AgregaRegistroIndividualCuyesYRetornos
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("CoopagcuyApi.Features.Faenamiento.Models.RegistroFaenamiento", b =>
                {
                    b.HasOne("CoopagcuyApi.Features.Productoras.Models.Lote", "Lote")
                        .WithOne("Faenamiento")
                        .HasForeignKey("CoopagcuyApi.Features.Faenamiento.Models.RegistroFaenamiento", "LoteId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
